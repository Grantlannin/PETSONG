...
export const LAB_INTAKE_FIELDS: LabField[] = [
  ...
  {
    key: 'special_relationships',
    label: 'Special Relationships',
    type: 'textarea',
    placeholder: 'Favorite person, rival, who they protect or cuddle with — family, friends, kids, other pets.',
    sample: String(SAMPLE_BRIEF.special_relationships || ''),
    required: false,
  },
  {
    key: 'if_they_could_talk',
    label: 'If They Could Talk',
    type: 'textarea',
    placeholder: 'What would they say all the time? Their catchphrase? How would they describe themselves or your family?',
    sample: String(SAMPLE_BRIEF.if_they_could_talk || ''),
    required: false,
  },
  {
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder:
      'Memories your family will never forget — helping through hard times, major life events, meaningful moments together.',
    hint: 'This is where the heartfelt song gets its weight.',
    sample: String(SAMPLE_BRIEF.emotional_moments || ''),
    required: false,
  },
  {
    key: 'occasion',
