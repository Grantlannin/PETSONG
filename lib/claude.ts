...
- Lead with personality (behaviors & quirks), things_they_hate, memorable_inside_jokes.
...
- Lead with personality (behaviors & quirks), physical_features, favorite_things, memorable_inside_jokes.
